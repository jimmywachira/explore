...
<footer class="relative w-full overflow-hidden transition-colors duration-300 mt-10 sm:mt-14">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute bottom-0 left-0 w-80 h-80 bg-green-400/10 rounded-full blur-3xl opacity-20"></div>
    </div>
    ...
    <div class="relative z-10">
        ...
        <div class="w-full lg:w-4/5 xl:w-3/4 mx-auto px-4 sm:px-6 lg:px-8 pt-14 sm:pt-16 lg:pt-20 pb-8 sm:pb-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-12 sm:mb-14">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-600 font-semibold tracking-widest">IMPORTS</p>
                            </div>
                        </div>
                ...
                <div class="space-y-5">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li>
                            <a href="/contact.php" class="group flex items-center gap-2 text-black hover:text-blue-600 transition-colors duration-300">
                                <ion-icon name="chevron-forward-outline" class="opacity-0 group-hover:opacity-100 transition-opacity -ml-2"></ion-icon>
                ...
                <div class="space-y-5">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li>
                            <a href="/inspection-guidance.php" class="group flex items-center gap-2 text-black hover:text-blue-600 transition-colors duration-300">
                                <ion-icon name="chevron-forward-outline" class="opacity-0 group-hover:opacity-100 transition-opacity -ml-2"></ion-icon>
                                <span class="group-hover:translate-x-1 transition-transform">Inspection Guidance</span>
                            </a>
                        </li>
                        <li>
                            <a href="/shipping-clearing.php" class="group flex items-center gap-2 text-black hover:text-blue-600 transition-colors duration-300">
                                <ion-icon name="chevron-forward-outline" class="opacity-0 group-hover:opacity-100 transition-opacity -ml-2"></ion-icon>
                                <span class="group-hover:translate-x-1 transition-transform">Shipping and Clearing</span>
                            </a>
                        </li>
                        <li>
                            <a href="/vehicle-sourcing-support.php" class="group flex items-center gap-2 text-black hover:text-blue-600 transition-colors duration-300">
                                <ion-icon name="chevron-forward-outline" class="opacity-0 group-hover:opacity-100 transition-opacity -ml-2"></ion-icon>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div class="flex gap-4 sm:gap-6 justify-center flex-wrap">
                    <a href="#" class="group text-xs sm:text-sm text-blue-600 hover:text-blue-600 transition-colors duration-300 relative">
                        <span>Privacy Policy</span>
                        <span class="h-0.5 bg-blue-600 scale-x-0 group-hover:scale-x-100 transition-transform origin-left absolute -bottom-1 w-full"></span>
                    </a>
                    <a href="#" class="group text-xs sm:text-sm text-blue-600 hover:text-blue-600 transition-colors duration-300 relative">
                ...
                <div class="flex items-center justify-start sm:justify-end gap-2">
                    <div class="w-8 h-8 rounded-lg bg-emerald-500/10 flex items-center justify-center border border-emerald-400/40">
                        <ion-icon name="shield-checkmark-outline" class="text-emerald-600 icon-lg"></ion-icon>
                    </div>
                    <p class="text-xs sm:text-sm text-blue-600">
                        <span class="text-blue-600 font-semibold">KEBS</span> Compliance Ready
                    </p>
                </div>
            </div>
        </div>
        ...
        <!-- Bottom Accent Line -->
        <div class="h-1 bg-linear-to-r from-transparent via-blue-600/60 to-transparent"></div>
    </div>
</footer>
