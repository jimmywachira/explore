...
<main class="w-full flex-1 text-blue-900">
    <div class="w-full lg:w-4/5 xl:w-3/4 mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-8 lg:py-10 space-y-6 sm:space-y-8">
        <section class="relative overflow-hidden rounded-3xl min-h-[420px] sm:min-h-[500px] lg:min-h-[580px] flex items-center">
            ...
            <div class="absolute inset-0 bg-linear-to-br from-blue-950/85 via-blue-950/55 to-blue-950/80"></div>
            <div class="absolute inset-0 bg-linear-to-r from-blue-950/75 via-blue-950/35 to-transparent"></div>

            <div class="relative z-10 p-6 sm:p-10 lg:p-14 w-full">
                <div class="max-w-4xl space-y-5 sm:space-y-6 text-white">
                    <p class="hero-kicker inline-flex items-center rounded-full border border-blue-300/60 bg-blue-400/15 px-4 py-1.5 text-xs sm:text-sm font-bold uppercase tracking-[0.2em] text-green-200">
        ...
        <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <article class="page-surface rounded-2xl p-4 sm:p-5 shadow-sm text-center">
                ...
                <p class="text-sm text-blue-700">Average Rating</p>
            </article>
            <article class="page-surface rounded-2xl p-4 sm:p-5 shadow-sm text-center">
            ...
            <article class="page-surface rounded-2xl p-4 sm:p-5 shadow-sm text-center">
                ...
                <p class="text-sm text-blue-700">Support Commitment</p>
            </article>
        </section>
        ...
        <section class="page-surface-strong rounded-3xl p-5 sm:p-6 lg:p-8 shadow-sm">
            <div class="text-center mb-8 sm:mb-10">
                ...
                <p class="text-sm sm:text-base text-blue-700 max-w-2xl mx-auto">Real voices. Real delivery experiences. Real outcomes for Kenyan car buyers importing from Japan.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">

                <article class="group overflow-hidden rounded-3xl page-surface transition-all duration-300 hover:border-emerald-400/50 hover:shadow-xl">
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <p class="text-sm text-blue-600">Happy Client Story</p>
                    </div>
                </article>
                ...
                <article class="group overflow-hidden rounded-3xl page-surface transition-all duration-300 hover:border-emerald-400/50 hover:shadow-xl">
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <p class="text-sm text-blue-600">Fleet and Commercial Investor</p>
                    </div>
                </article>
                ...
                <article class="group overflow-hidden rounded-3xl page-surface transition-all duration-300 hover:border-emerald-400/50 hover:shadow-xl">
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <p class="text-sm text-blue-600">Vehicle Import Customer</p>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class="page-surface-strong rounded-3xl p-5 sm:p-6 lg:p-8 shadow-sm">
            <div class="text-center mb-8 sm:mb-10">
                ...
                <p class="text-sm sm:text-base text-blue-700 max-w-2xl mx-auto">From communication quality to final handover, these are the moments clients remember.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                <article class="page-surface rounded-2xl p-6 sm:p-7 hover:border-emerald-400/40 transition">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-500">Taxi Business Owner</p>
                            </div>
                        </div>
                    ...
                    <p class="text-sm text-blue-700 leading-relaxed">Xplore Car Imports handled everything from selection to customs with professionalism. I saved money and time, and the process felt fully managed end to end.</p>
                </article>
                ...
                <article class="page-surface rounded-2xl p-6 sm:p-7 hover:border-emerald-400/40 transition">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-500">Happy Client Story</p>
                            </div>
                        </div>
                        <div class="flex gap-1 text-emerald-500" aria-label="5 star rating">
                            <ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon>
                    ...
                    <p class="text-sm text-blue-700 leading-relaxed">I had many questions before importing, and the team answered each one clearly. My vehicle arrived in excellent condition, exactly as promised.</p>
                </article>
                ...
                <article class="page-surface rounded-2xl p-6 sm:p-7 hover:border-emerald-400/40 transition">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-500">Commercial Investor</p>
                            </div>
                        </div>
                        <div class="flex gap-1 text-emerald-500" aria-label="5 star rating">
                            <ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon>
                    ...
                    <p class="text-sm text-blue-700 leading-relaxed">I imported multiple vehicles for business and the consistency was impressive. Their customs expertise and communication made scaling my fleet easier.</p>
                </article>
                ...
                <article class="page-surface rounded-2xl p-6 sm:p-7 hover:border-emerald-400/40 transition">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-500">Family Business Owner</p>
                            </div>
                        </div>
                        <div class="flex gap-1 text-emerald-500" aria-label="5 star rating">
                            <ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon>
                    ...
                    <p class="text-sm text-blue-700 leading-relaxed">The guidance was honest and practical. I was helped to choose within budget and still get quality. Delivery was faster than I expected.</p>
                </article>
                ...
                <article class="page-surface rounded-2xl p-6 sm:p-7 hover:border-emerald-400/40 transition">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-500">Transport Business Owner</p>
                            </div>
                        </div>
                        <div class="flex gap-1 text-emerald-500" aria-label="5 star rating">
                            <ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon>
                    ...
                    <p class="text-sm text-blue-700 leading-relaxed">Their transparency stands out. Every detail was explained, and I always knew the next step. I now refer friends and colleagues to Xplore.</p>
                </article>
                ...
                <article class="page-surface rounded-2xl p-6 sm:p-7 hover:border-emerald-400/40 transition">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-blue-500">Executive Professional</p>
                            </div>
                        </div>
                        <div class="flex gap-1 text-emerald-500" aria-label="5 star rating">
                            <ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon><ion-icon name="star"></ion-icon>
                    ...
                    <p class="text-sm text-blue-700 leading-relaxed">The process was clear from start to finish and the final car quality was excellent. It felt secure, transparent, and worth every step.</p>
                </article>
            </div>
        </section>
        ...
        <section class="page-surface-strong relative overflow-hidden rounded-3xl shadow-xl">
            ...
            <div class="relative p-5 sm:p-6 lg:p-8 text-center">
                ...
                <div class="flex flex-wrap justify-center gap-3">
                    <a href="/contact.php" class="inline-flex items-center rounded-xl bg-emerald-600 px-5 py-3 text-white font-black hover:bg-emerald-700 transition">
