...
<main class="w-full flex-1 text-slate-900">
    <div class="w-full lg:w-4/5 xl:w-3/4 mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 lg:py-12 space-y-8 sm:space-y-10">
            ...
            <div class="relative p-6 sm:p-8 lg:p-12">
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-end">
                    <div class="lg:col-span-2 space-y-4">
                        <p class="inline-flex items-center gap-2 rounded-full bg-white/30 px-3 py-1 text-xs sm:text-sm font-bold uppercase tracking-[0.2em]">
        ...
        <section class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <div class="rounded-2xl border border-slate-200 bg-white/80 p-4 sm:p-5 shadow-sm">
                ...
                <p class="text-sm text-slate-700">Weeks typical shipping window</p>
            </div>
            <div class="rounded-2xl border border-slate-200 bg-white/80 p-4 sm:p-5 shadow-sm">
                ...
                <p class="text-sm text-slate-700">Price transparency commitment</p>
            </div>
            <div class="rounded-2xl border border-slate-200 bg-white/80 p-4 sm:p-5 shadow-sm">
                ...
                <p class="text-sm text-slate-700">Compliance-first sourcing policy</p>
            </div>
            <div class="rounded-2xl border border-slate-200 bg-white/80 p-4 sm:p-5 shadow-sm">
                ...
                <p class="text-sm text-slate-700">Dedicated buyer guidance</p>
            </div>
        </section>
        ...
        <section class="rounded-3xl border border-slate-200 bg-white/85 p-5 sm:p-7 lg:p-8 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                <article class="rounded-2xl border border-slate-200 p-4 sm:p-5 bg-slate-50/80">
                    ...
                    <p class="text-sm text-slate-700">We identify options matching your budget, preferences, and business needs from trusted Japanese suppliers.</p>
                </article>
                <article class="rounded-2xl border border-slate-200 p-4 sm:p-5 bg-slate-50/80">
                    ...
                    <p class="text-sm text-slate-700">Every shortlisted car is backed by condition details, mileage checks, and history verification before commitment.</p>
                </article>
                <article class="rounded-2xl border border-slate-200 p-4 sm:p-5 bg-slate-50/80">
                    ...
                    <p class="text-sm text-slate-700">We manage booking and shipping timelines while sharing status updates so you know exactly where your car is.</p>
                </article>
                <article class="rounded-2xl border border-slate-200 p-4 sm:p-5 bg-slate-50/80">
                    ...
                    <p class="text-sm text-slate-700">Our team supports the clearing process with practical guidance on documents, timelines, and expected costs.</p>
                </article>
                <article class="rounded-2xl border border-slate-200 p-4 sm:p-5 bg-slate-50/80">
                    ...
                    <p class="text-sm text-slate-700">Need a taxi-ready or business-focused unit? We advise on model selection, efficiency, and operating considerations.</p>
                </article>
                <article class="rounded-2xl border border-slate-200 p-4 sm:p-5 bg-slate-50/80">
                    ...
                    <p class="text-sm text-slate-700">From arrival updates to collection planning, we help ensure a smooth final step before you hit the road.</p>
                </article>
            </div>
        </section>

        <section class="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6">
            <div class="rounded-3xl border border-slate-200 bg-white/85 p-5 sm:p-7 shadow-sm">
                <p class="text-xs uppercase tracking-[0.2em] text-emerald-600 font-bold">How It Works</p>
                <h2 class="text-2xl sm:text-3xl font-black mt-2 mb-4 inline-flex items-center gap-2"><ion-icon name="git-network-outline" class="icon-lg"></ion-icon>Simple, Structured, Transparent</h2>
                <ol class="space-y-3 text-sm sm:text-base text-slate-700 list-decimal pl-5">
